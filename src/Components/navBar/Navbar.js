...
function Navbar({ setOpenLoginModal, loggedIn, setLoggedIn, user, userImage }) {
      ...
      `GoodBye ${
        user.length > 8
          ? user.charAt(0).toUpperCase() +
            user.split(" ").slice(0, 1).join("").slice(1)
  ...
  console.log(
    user.length > 8 ? user.split(" ").slice(0, 1).join("") : user,
    ...
    <div className="navbar">
      <div className="nav">
        ...
        <NavLink
          ...
          className="nav-inner"
          id="teams"
          onClick={(e) => setMenuIdActive(e.target.id)}
        >
          <div>TEAMS </div>
        </NavLink>
        <NavLink
      ...
      <div className="nav2">
        ...
        >
          <div className="setToggleMenu">
            {toggleMenu ? "Options" : " More.."}
             ...
             {loggedIn && user === "alexander perez" && (
               ...
               >
                 <div className="submenu__item" id="More..">
                   Add New Team
                 </div>
               </Link>
             )}
        ...
        {loggedIn && (
          <button className="navLogInOutButton" onClick={logOut}>
            Log out
          </button>
        )}
        {!loggedIn && (
          <button className="navLogInOutButton" onClick={handleClickModal}>
            Log in
          </button>
        )}
      ...
      <div className={sideNavar}>
        ...
        <div className="entrada">
          ...
          <NavLink to="/" className="topicLink" onClick={changeNav}>
            Teams
          </NavLink>
          <NavLink
            to="/teams/allplayers"
          ...
          <NavLink to="/teams/Season" className="topicLink" onClick={changeNav}>
            Season
          </NavLink>
          <NavLink to="/teams/News" className="topicLink" onClick={changeNav}>
            News
          </NavLink>
          <NavLink to="/teams/About" className="topicLink" onClick={changeNav}>
            About
          </NavLink>
